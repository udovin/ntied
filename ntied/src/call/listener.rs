...
impl CallListener for StubListener {
    async fn on_incoming_call(&self, _address: Address, _video_enabled: bool) {}
    async fn on_outgoing_call(&self, _address: Address, _video_enabled: bool) {}
    async fn on_call_accepted(&self, _address: Address) {}
    async fn on_call_rejected(&self, _address: Address) {}
    async fn on_call_connected(&self, _address: Address, _is_muted: bool) {}
